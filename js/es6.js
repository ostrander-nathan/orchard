console.log("es6");
// const - Will not change cant redifine 
const a=8;
console.log("a",a);
// let - only used in block its defined in and IS reassignable --- Local
let b=8;
console.log("b",b );
b =12
console.log("b2",b)
...
console.log("refect in ES5",reflect("ES5 is so yesterday"));

var reflect2=(value)=> {
	return value;
}
console.log("refect in ES6",reflect2("ES6 is the new hotness"));
...
// object lilteral property shorthand
...
// can do if key and value are the same
let myNewObject = {
	wow,es6,numNum
}
